...
class OrdenProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create orden_producto" do
    assert_difference('OrdenProducto.count') do
      post orden_productos_url, params: { orden_producto: { cantidad: @orden_producto.cantidad, descuento: @orden_producto.descuento, instrucciones: @orden_producto.instrucciones, orden: @orden_producto.orden, precio: @orden_producto.precio, producto: @orden_producto.producto } }
    end
  ...
  test "should update orden_producto" do
    patch orden_producto_url(@orden_producto), params: { orden_producto: { cantidad: @orden_producto.cantidad, descuento: @orden_producto.descuento, instrucciones: @orden_producto.instrucciones, orden: @orden_producto.orden, precio: @orden_producto.precio, producto: @orden_producto.producto } }
